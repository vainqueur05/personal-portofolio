...
services_data = [
    {"titre": "Site vitrine", "description": "Un site élégant et responsive pour présenter votre activité, vos produits ou vos services. Idéal pour les petites entreprises et les indépendants.", "icone": "bi-briefcase", "prix": "Sur devis", "features": ["Design sur mesure", "Optimisé mobile", "Formulaire de contact", "SEO de base"]},
    {"titre": "Portfolio professionnel", "description": "Mettez en valeur vos réalisations avec un portfolio moderne et épuré. Parfait pour les photographes, artistes, développeurs, etc.", "icone": "bi-images", "prix": "Sur devis", "features": ["Galerie d'images", "Filtres par catégorie", "Page de détail", "Animations"]},
    {"titre": "Application web sur mesure", "description": "Développement d'applications web personnalisées avec Flask et JavaScript. De l'idée au déploiement, je vous accompagne.", "icone": "bi-gear", "prix": "Sur devis", "features": ["Backend Python/Flask", "Base de données", "Authentification", "API REST"]},
    {"titre": "Refonte de site", "description": "Vous avez déjà un site mais il ne vous satisfait plus ? Je le modernise pour le rendre plus attractif et performant.", "icone": "bi-arrow-repeat", "prix": "Sur devis", "features": ["Audit", "Nouveau design", "Amélioration des performances", "Migration"]},
    {"titre": "Conseil & Formation", "description": "Besoin de conseils sur votre projet web ? Ou envie d'apprendre les bases du développement ? Je propose des sessions adaptées.", "icone": "bi-chat-dots", "prix": "Sur devis", "features": ["Analyse des besoins", "Recommandations techniques", "Cours particuliers", "Support"]},
]
